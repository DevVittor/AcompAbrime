...
app.get('/',userController.index);//Usando controller
...
app.get('/:id',(req,res)=>{
    ...
    const nameProfile = "Fernanda Lima"
    const ageProfile = 26
    ...
    const descricaoProfile = "Apenas uma descrição simples para colocar no profile dessa página";
    res.json(
        {
            fotos: Foto,
            page:title,
            description: descricaoProfile,
            profile:nameProfile,
            age: ageProfile,
            estado: estado,
            cidade:cidade,
